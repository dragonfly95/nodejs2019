...
public class CustomCalendarView extends LinearLayout {
    ...
    private void generateDateView() {
        ...
        final int currentYear = currentCalendar.get(Calendar.YEAR);          // 년
        final int currentMonth = currentCalendar.get(Calendar.MONTH);        // 월
        final int currentDay = currentCalendar.get(Calendar.DAY_OF_MONTH);   // 일
        ...
        public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
            if (dateList != null && position < calList.size()) {
                ...
                if (lastSelectedPosition == position) {
                    yearMonthTextview.setText(String.valueOf(month + " / " + year));
                    ((ViewHolder) holder).textItemLayout.setBackgroundColor(getResources().getColor(R.color.orange));
                } else {
                    ((ViewHolder) holder).textItemLayout.setBackgroundColor(getResources().getColor(R.color.gray_light));
                }
